...
namespace Table
{
    public partial class Form1 : Form
    {
        ...
        {
            dgvBooks.ColumnCount = 5;
            dgvBooks.Columns[4].Name = "Genre";
            var column = dgvBooks.Columns["Genre"];
            column.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

            dgvBooks.Rows.Add("1", "To Kill a Mockingbird", "Harper Lee", "1960", "Classic Fiction");
            dgvBooks.Rows.Add("2", "1984", "Goerge Orwell", "1949", "Dystopian");
            dgvBooks.Rows.Add("3", "The Great Gatsby", "F. Scott Fitzgerald", "1925", "Classic Fiction");
        }
